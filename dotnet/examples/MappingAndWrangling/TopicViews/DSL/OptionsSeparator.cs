...
namespace PushTechnology.ClientInterface.Examples.MappingAndWrangling.TopicViews.DSL
{
    public sealed class OptionsSeparator : Example
    {
        public override async Task Run(CancellationToken cancellationToken, string[] args)
        {
            ...
            string json = "{\"Flintstones\":[\"Fred/Flintstone\",\"Wilma/Flintstone\",\"Pebbles/Flintstone\"]}";
            ...
            var view1 = await session.TopicViews.CreateTopicViewAsync("topic_view_1", "map my/topic/path to views/<scalar(/Flintstones)> separator '_'", cancellationToken);
