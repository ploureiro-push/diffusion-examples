...
namespace PushTechnology.ClientInterface.Examples.MappingAndWrangling.TopicViews.DSL
{
    public sealed class OptionsThrottle : Example
    {
        public override async Task Run(CancellationToken cancellationToken, string[] args)
        {
            ...
            var view1 = await session.TopicViews.CreateTopicViewAsync("topic_view_1", "map my/topic/path to views/<path(0)> throttle to 1 update every 10 seconds", cancellationToken);
            ...
            session.Topics.RemoveStream(valueStream);
