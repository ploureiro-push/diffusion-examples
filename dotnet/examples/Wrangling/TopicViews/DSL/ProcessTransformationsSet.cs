...
namespace PushTechnology.ClientInterface.Examples.Wrangling.TopicViews.DSL
{
    public sealed class ProcessTransformationsSet : Example
    {
        public override async Task Run(CancellationToken cancellationToken, string[] args)
        {
            ...
            await session.TopicControl.RemoveTopicsAsync("my/topic/path/1", cancellationToken);
            await session.TopicControl.RemoveTopicsAsync("my/topic/path/2", cancellationToken);
