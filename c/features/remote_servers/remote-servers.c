        ...
        DIFFUSION_REMOTE_SERVER_T *remote_server)
{
        printf("Name: %s\n", remote_server->name);
        printf("URL: %s\n", remote_server->url);
        printf("Principal: %s\n", remote_server->principal);

        printf("Connection Options:\n");
        print_connection_options(remote_server->connection_options);
}
...
int main(int argc, char** argv)
{
        ...
        HASH_NUM_T *connection_options = hash_num_new(10);
        hash_num_add(connection_options, DIFFUSION_REMOTE_SERVER_CONNECTION_OPTION_RECONNECTION_TIMEOUT, "120000"); // milliseconds
        hash_num_add(connection_options, DIFFUSION_REMOTE_SERVER_CONNECTION_OPTION_RETRY_DELAY, "2000"); // milliseconds
        hash_num_add(connection_options, DIFFUSION_REMOTE_SERVER_CONNECTION_OPTION_RECOVERY_BUFFER_SIZE, "5000");
        hash_num_add(connection_options, DIFFUSION_REMOTE_SERVER_CONNECTION_OPTION_INPUT_BUFFER_SIZE, "1024"); // kilobytes
        hash_num_add(connection_options, DIFFUSION_REMOTE_SERVER_CONNECTION_OPTION_OUTPUT_BUFFER_SIZE, "2048"); // kilobytes
        hash_num_add(connection_options, DIFFUSION_REMOTE_SERVER_CONNECTION_OPTION_MAXIMUM_QUEUE_SIZE, "7500"); // milliseconds
        hash_num_add(connection_options, DIFFUSION_REMOTE_SERVER_CONNECTION_OPTION_CONNECTION_TIMEOUT, "120000"); // milliseconds
        hash_num_add(connection_options, DIFFUSION_REMOTE_SERVER_CONNECTION_OPTION_WRITE_TIMEOUT, "300000"); // milliseconds
        ...
        DIFFUSION_CREATE_REMOTE_SERVER_PARAMS_T create_remote_server_params = {
                ...
                .principal = "admin",
                .credentials = remote_server_credentials,
